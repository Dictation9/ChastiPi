"""
Keyholder Configuration Service
Manages keyholder-specific configuration settings using the centralized config system
"""
import json
import os
...
class KeyholderConfigService:
    """Service for managing keyholder configuration settings"""
    ...
    def get_all_settings(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "keyholder": self._get_keyholder_settings(),
    ...
    def _get_time_verification_settings(self) -> Dict[str, Any]:
        """Get time verification settings"""
        return {
    ...
    def update_settings(self, updates: Dict[str, Any]) -> List[str]:
        """Update configuration settings and return validation errors"""
        errors = []
    ...
    def export_config(self) -> str:
        """Export current configuration as formatted text"""
        return self.config.export_config()
    
    def import_config(self, config_text: str) -> List[str]:
        """Import configuration from text format"""
        return self.config.import_config(config_text)
